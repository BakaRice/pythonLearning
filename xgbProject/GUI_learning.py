...
def modifyHtml(htmlcode):  # html修改
    ...
    # 进行正则表达式替换
    modifiedcode = re.sub(pattern,
                          '<p style="text-align:justify;"><span style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',
                          htmlcode)
    modifiedcode = re.sub(pattern1, '<div align="center"><table cellpadding="0" cellspacing="0" width="600">',
                          modifiedcode)
